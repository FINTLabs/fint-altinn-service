...
public class EbevisConsentRequestProducer {
    ...
    public EbevisConsentRequestProducer(ParameterizedTemplateFactory parameterizedTemplateFactory) {
        this.parameterizedTemplate = parameterizedTemplateFactory.createTemplate(KafkaEvidenceConsentRequest.class);
    }
    ...
    public void publish(KafkaEvidenceConsentRequest consentRequest) {
        ...
        EventTopicNameParameters topicNameParameters = EventTopicNameParameters.builder()
